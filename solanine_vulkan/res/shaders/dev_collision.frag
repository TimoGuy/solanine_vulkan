...
layout (location = 4) flat in uint baseInstanceID;
...
void main()
{
    ...
    vec2 calculatedUV = (rotateFromAtoB(inNormal, vec3(0.0, 1.0, 0.0)) * inObjectPos).xz;
    ...
    if (n.y > material.slopeAngleSin)
        baseColor *= material.standableColor.rgb;
    else
