    ...
    if (isEnemy(_data))  // @NOCHECKIN
    {
        ...
        std::vector<physengine::BoundHitCapsule> hitCapsules = {
            ...
            },
            {
                ...
                .offset = { 0.0f, 0.155458f, 0.0f },
                .height = 0.310916f,
                .radius = 0.05f,
            },
            {
                .boneName = "Forearm.L",
                .offset = { 0.0f, 0.1292575f, 0.0f },
                .height = 0.258515f,
                .radius = 0.035f,
            },
            {
                .boneName = "Hand.L",
                .offset = { 0.0f, 0.0438675f, 0.0f },
                .height = 0.087735f,
                .radius = 0.03f,
            },
            {
            ...
            {
                .boneName = "Thigh.L",
                .offset = { 0.025f, 0.125f, 0.0f },
                .height = 0.31f,
                .radius = 0.09f,
            },
            {
                .boneName = "Calf.L",
                .offset = { -0.025f, 0.185f, 0.0f },
                .height = 0.37f,
                .radius = 0.06f,
            },
            {
