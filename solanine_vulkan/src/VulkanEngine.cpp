...
void VulkanEngine::loadImages()
{
	...
	// Load cubemapSkybox
	{
		...
		//	cubemapSkybox.image
		//);
		vkutil::loadImageCubemapFromFile(  // @NOTE: @NOCHECKIN: this will be obsolete once the generated skybox is here. make sure to include the deletion of this stuff in its own commit!
			*this,
			{
